...
{
    sealed public class CreatePlaylistViewModel : BaseVM
    {
        ...
        public override async Task Initialize()
        {
            ...
            {
                Songs.Add(new SongViewItem { Song = song, Checked = false });
            }
        }
        ...
        private async void Save()
        {
            if (Validator.IsValid)
            {
                ...
                await _playlistService.CreatePlaylist(_title, checkedSongsIds);
